...
i_re=(BP(ei,e)/re_t);
{
double m00_fabs(d00_fabs0,i_re)
double m00_pow(d00_pow1,d00_fabs0,afre)
#if defined(_DERIVATE)
double m10_fabs(d10_fabs0,d00_fabs0,i_re)
double m10_pow(d10_pow1,d00_pow1,d00_fabs0,afre)
#endif
#if defined(_DERIVATE)
flicker_Pwr_Vei_e=(kfre*(d10_pow1*i_re_Vei_e*d10_fabs0));
flicker_Pwr_Vtnode_GND=(kfre*(d10_pow1*i_re_Vtnode_GND*d10_fabs0));
...
_save_whitenoise2(bi,ci,(twoq*fabs(ibci)),"shot");
_save_whitenoise2(bp,ei,(twoq*ibep),"shot");
_save_whitenoise2(bp,ci,(twoq*fabs(ijbcx)),"shot");
_save_whitenoise2(si,ci,(twoq*fabs(ijsc)),"shot");
if
((flcono==1))
{
#if defined(_DYNAMIC)
